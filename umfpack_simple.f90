...
!
  ...
  integer ( kind = 4 ), dimension ( nnz ) :: ai = (/ 0, 1, 0, 2, 4, 1, 2, 3, 4, 2, 1, 4 /)
  integer ( kind = 4 ), dimension ( n + 1 ) :: ap = (/ 0, 2, 5, 9, 10, 12 /)
  real ( kind = 8 ), dimension ( nnz ) :: ax = (/  2.0,  3.0, 3.0, -1.0, 4.0, 4.0, -3.0, 1.0, 2.0, 2.0, 6.0, 1.0 /)
  real ( kind = 8 ), dimension ( n ) :: b = (/ 8.0, 45.0, -3.0, 3.0, 19.0 /)
